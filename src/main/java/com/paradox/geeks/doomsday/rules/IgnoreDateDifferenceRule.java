...
public class IgnoreDateDifferenceRule implements Rule{
    @Override
    ...
    public void handleReplayResponse(GorRequest request, GorOriginalResponse originalResponse, GorReplayedResponse replayedResponse) {
        originalResponse.getHeader("Date").ifPresent(origDate -> replayedResponse.replaceHeader("Date", replayDate -> origDate));
    }
}
